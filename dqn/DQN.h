...
struct DQNImpl : torch::nn::Module {
	 ...
	 DQNImpl(int64_t state_size, int64_t action_size) 
	 	:conv1(torch::nn::Conv2dOptions(BATCH_SIZE, 64, 1).stride(8)),
		conv2(torch::nn::Conv2dOptions(64, 64, 1).stride(4)),
		conv3(torch::nn::Conv2dOptions(64, 128, 1).stride(1)),
		linear1(torch::nn::Linear(16, 512) ),
	 	linear2(torch::nn::Linear(512, ADA_ACTION) ),
		state_conv1(torch::nn::Conv2dOptions(1, state_size, 1).stride(4)),
		state_conv2(torch::nn::Conv2dOptions(state_size, 64, 1).stride(2)),
		state_conv3(torch::nn::Conv2dOptions(64, 64, 1).stride(1)),
		state_linear1(torch::nn::Linear(224, 512) ),
