      ...
      for (int i = 0; i < nbUE; i++)
        {
          ...
          for (int k = 0; k < nbFemtoCells; k++)
            {
              c_dl = new ChannelRealization (nm->GetHomeGNodeBContainer()->at (k), ue, ChannelRealization::CHANNEL_MODEL_FEMTOCELL_URBAN);
              nm->GetHomeGNodeBContainer()->at (k)->GetPhy ()->GetDlChannel ()->GetPropagationLossModel ()->AddChannelRealization (c_dl);
              c_ul = new ChannelRealization (ue, nm->GetHomeGNodeBContainer()->at (k), ChannelRealization::CHANNEL_MODEL_FEMTOCELL_URBAN);
              nm->GetHomeGNodeBContainer()->at (k)->GetPhy ()->GetUlChannel ()->GetPropagationLossModel ()->AddChannelRealization (c_ul);
            }
